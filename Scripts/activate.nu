...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Gilbert Blankson\MY COOL STUFF\MY DEV STUDIES\PYTHON\py_lessons\NetflixDataAnalysis'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Gilbert Blankson\MY COOL STUFF\MY DEV STUDIES\PYTHON\py_lessons\NetflixDataAnalysis\Scripts\deactivate.nu'
